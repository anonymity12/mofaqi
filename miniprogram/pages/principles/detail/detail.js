...
**二冲程发动机**仅需曲轴旋转一周（活塞上下运动一次）即可完成一个工作循环，而**四冲程发动机**需要曲轴旋转两周（活塞上下运动两次）才能完成一个工作循环。
...
| 材料 | 优点 | 缺点 |
|------|------|------|
| 钢管 | 强度高，易加工，成本低 | 重量大，易锈蚀 |
| 铝合金 | 重量轻，抗腐蚀 | 成本高，柔韧性较差 |
| 钛合金 | 强度极高，重量轻 | 极其昂贵，加工难度大 |
| 碳纤维 | 最轻，可定制刚性 | 价格昂贵，受损难修复 |
